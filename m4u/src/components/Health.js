...
function Health() {
  return (
    ...
    <div className='hhsub'><h3>The team of researchers from Russia, Germany and France said the biological risk of reanimating the viruses they studied was “totally negligible"</h3></div>
